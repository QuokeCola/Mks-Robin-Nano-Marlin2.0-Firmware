...
#define STRING_CONFIG_H_AUTHOR "(ZJUI, QuokeCola)" // Who made the changes.
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -36, -0.8 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT (170)    // Y point for Z homing when homing all axes (G28).
#endif
